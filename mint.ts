...
const MY_TOKEN_METADATA: UploadMetadataInput = {
    name: "Suck Face",
    symbol: "S",
    description: "Face of Suck",
    image: "https://imgur.com/a/HDOkBll"
}
...
export const userWallet = Keypair.fromSecretKey(new Uint8Array(secret));
export let mintKeypair = Keypair.generate();
const main = async() => {
